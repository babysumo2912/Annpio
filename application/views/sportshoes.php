    ...
    <div class="col-md-3">
        <div class="menuleft">
            ...
            <ul>
                ...
                <li class="actived"><a href="<?php echo base_url()?>sportshoes">Sport Shoes</a></li>
            ...
            foreach ($product as $item) {
                ...
                <div class="col-sm-3 widthpro">
                    <form action="#" method="post" class="form-group">
                        ...
                        <div class="buy">
                            <a href="<?php echo base_url()?>sportshoes/buy/<?php echo $item->id?>" class="form-control">
                                <span class="glyphicon glyphicon-shopping-cart"></span>&nbsp;
                                Buy Now
                            </a>
                        </div>
            ...
            <ul class="pagination">
                ...
                if(isset($fullpage)) {
                    for ($page = 1; $page <= $fullpage; $page++) {
                        ?>
                        <li>
                            <a href="<?php echo base_url()?>sportshoes/page/<?php echo $page?>"><?php echo $page ?></a>
                        </li>
                        <?php
                    }
                }
