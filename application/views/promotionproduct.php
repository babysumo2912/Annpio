    ...
    <div class="col-md-3">
        <div class="menuleft">
            ...
            <ul>
                ...
                <li class="actived"><a href="<?php echo base_url()?>promotion-product">Promotion product</a></li>
            </ul>
        </div>
    </div>
            ...
            <ul class="pagination">
                ...
                if(isset($fullpage)) {
                    for ($page = 1; $page <= $fullpage; $page++) {
                        ?>
                        <li>
                            <a href="<?php echo base_url()?>promotionproduct/page/<?php echo $page?>"><?php echo $page ?></a>
                        </li>
                        <?php
                    }
                }
