...
<div class="row centerpro">
    ...
    <div class="text-center">
        <a href="<?php echo base_url()?>oder/giaohang/<?php echo $item->id?>" class="btn btn-success">
        ...
        <?php
            foreach ($oder as $item) {
                ...
                <tr>
                    ...
                    <td><?php echo $item->ghichu ?></td>
                    <td>
                        <a href="<?php echo base_url() ?>oder/view_chitiet/<?php echo $item->id ?>"
                           class="btn btn-primary edit" title="Xem chi tiết">
                            <span class="glyphicon glyphicon-search"></span>
                        </a>
                        <a href="<?php echo base_url()?>oder/delete/<?php echo $item->id?>" class="btn btn-danger delete" title="Hủy hóa đơn">
        ...
        <ul class="pagination">
            ...
            if(isset($fullpage)) {
                for ($page = 1; $page <= $fullpage; $page++) {
                    ?>
                    <li>
                        <a href="<?php echo base_url()?>oder/page/<?php echo $page?>"><?php echo $page ?></a>
                    </li>
                    <?php
                }
            }
