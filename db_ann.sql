...
INSERT INTO `tb_product` (`id`, `img`, `name`, `price`, `price_nhap`, `number`, `number_kho`, `madanhmuc`, `size`, `mota`) VALUES
...
(119, 'skiiny5.jpg', 'Quần Skinny co giãn 4 chiều ', 520000, 480000, 10, 10, 'QU', 'XXL', '<p>Mo ta thanh cong nhe</p>'),
